...
const YourPhotographer = props => (
  <div className="your-photographer">
    <Content>
      <img src="images/photographer.jpg" alt="Portrait of the photographer" className="your-photographer__portrait" />
      ...
      <PageCopy>
        ...
        Arizona. I know what beautiful looks like and I specialize in making women of all ages see their beauty through
        contemporary studio portraits. I want to photograph every person who has ever looked in the mirror and thought,
        "I'm not good enough" and prove them wrong. I want to document and celebrate every year of your life with you.
      </PageCopy>
      <PageCopy>
